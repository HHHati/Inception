...
if [ ! -f "/var/www/wordpress/wp-config.php" ]; then
	...
	wp core install --allow-root --path='/var/www/wordpress' --url=bade-lee.42.fr --title=Inception --admin_user=$SQL_USER --admin_password=$SQL_PASSWORD --admin_email=$WP_ADMIN_EMAIL
